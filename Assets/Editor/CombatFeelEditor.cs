...
public static class CombatFeelEditor
{
    ...
    public static void Apply()
    {
        ...
        System.IO.Directory.CreateDirectory("Assets/FX/Combat");
        System.IO.Directory.CreateDirectory("Assets/Animations/Combat");
        ...
        var prefab=PrefabUtility.LoadPrefabContents("Assets/Prefabs/Managers/CombatManager.prefab");
        Tune(prefab.GetComponent<CombatManager>(),hit,swing,block,impact,sparks);
        PrefabUtility.SaveAsPrefabAsset(prefab,"Assets/Prefabs/Managers/CombatManager.prefab");PrefabUtility.UnloadPrefabContents(prefab);
        ...
        texture.Apply();System.IO.File.WriteAllBytes("Assets/FX/Combat/HurtVignette.png",texture.EncodeToPNG());Object.DestroyImmediate(texture);
        AssetDatabase.ImportAsset("Assets/FX/Combat/HurtVignette.png");
        var importer=(TextureImporter)AssetImporter.GetAtPath("Assets/FX/Combat/HurtVignette.png");
        ...
        image.sprite=AssetDatabase.LoadAssetAtPath<Sprite>("Assets/FX/Combat/HurtVignette.png");image.raycastTarget=false;image.color=Color.clear;
    ...
    {
        string path="Assets/Data/Audio/"+name+".asset";
        ...
        data.clips=AssetDatabase.FindAssets(prefix+" t:AudioClip",new[]{"Assets/Audio"}).Select(g=>AssetDatabase.LoadAssetAtPath<AudioClip>(AssetDatabase.GUIDToAssetPath(g))).Take(3).ToArray();
    ...
    static GameObject Particle(string name,Color color,float size,int count)
    {
        ...
        string matPath="Assets/FX/Combat/Impact.mat";var mat=AssetDatabase.LoadAssetAtPath<Material>(matPath);
        ...
        var saved=PrefabUtility.SaveAsPrefabAsset(go,"Assets/FX/Combat/"+name+".prefab");Object.DestroyImmediate(go);return saved;
    }
    static void EnableEnemyOverlays()
    {
        var prefab=PrefabUtility.LoadPrefabContents("Assets/Prefabs/Enemies/HumanoidEnemy.prefab");
        ...
        PrefabUtility.SaveAsPrefabAsset(prefab,"Assets/Prefabs/Enemies/HumanoidEnemy.prefab");PrefabUtility.UnloadPrefabContents(prefab);
        ...
        prefab=PrefabUtility.LoadPrefabContents("Assets/Prefabs/Managers/CombatManager.prefab");
    ...
    {
        EnableEnemyOverlays();
        var controller=AssetDatabase.LoadAssetAtPath<AnimatorController>("Assets/Animations/HumanoidController.controller");
        ...
        const string path="Assets/Animations/Combat/Enemy_Hurt.anim";
    ...
    static void Animate()
    {
        var controller=AssetDatabase.LoadAssetAtPath<AnimatorController>("Assets/Animations/FirstPersonTable.controller");
    ...
    static void Recoil(AnimatorStateMachine machine)
    {
        ...
        const string path="Assets/Animations/Combat/Player_Hurt.anim";
        var clip=AssetDatabase.LoadAssetAtPath<AnimationClip>(path);
    ...
    {
        var idle=AssetDatabase.LoadAssetAtPath<AnimationClip>("Assets/Animations/Farzan anims/Idle.anim");
        var hold=AssetDatabase.LoadAssetAtPath<AnimationClip>("Assets/Animations/Farzan anims/Attack_Hold.anim");
        var cut=AssetDatabase.LoadAssetAtPath<AnimationClip>("Assets/Animations/Farzan anims/Attack_Release.anim");
    ...
    static void ConstrainWindup(AnimationClip clip)
    {
        ...
        var rig=PrefabUtility.LoadPrefabContents("Assets/Characters/TablePlayer/TablePlayer.prefab");
        try
        {
    ...
    static void Visit(AnimatorStateMachine machine)
    {
        foreach(var child in machine.states)
        {
            ...
            var source=AssetDatabase.LoadAssetAtPath<AnimationClip>("Assets/Animations/Farzan anims/"+state.name+".anim");
            if(source==null)continue;
            string path="Assets/Animations/Combat/"+state.name+".anim";
            var clip=AssetDatabase.LoadAssetAtPath<AnimationClip>(path);
            if(clip==null){clip=Object.Instantiate(source);AssetDatabase.CreateAsset(clip,path);}else EditorUtility.CopySerialized(source,clip);
        ...
        {
            const string path="Assets/Animations/Combat/Attack_HeavyRelease.anim";
