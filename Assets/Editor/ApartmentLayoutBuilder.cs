...
public static class ApartmentLayoutBuilder
{
    ...
    public static void Build()
    {
        ...
        if(scene.path != "Assets/Scenes/Room.unity" || EditorApplication.isPlaying) throw new InvalidOperationException("Open Room in edit mode first.");
        if(GameObject.Find("Apartment Layout")) throw new InvalidOperationException("Apartment already exists. Edit its geometry directly.");
        ...
        root=new GameObject("Apartment Layout").transform; Undo.RegisterCreatedObjectUndo(root.gameObject,"Apartment layout");
    ...
    public static void Repair() {
        ...
        var material=AssetDatabase.LoadAssetAtPath<Material>("Assets/Materials/Apartment/Apartment Blockout Walls.mat");
        ...
        var viewpoint=t.Find("LateralTorso/VerticalNeck/ViewPoint");
        foreach(var camera in t.GetComponentsInChildren<Camera>(true)) {
        ...
        var body=manager.Get(PlayerKind.Room).body;
    ...
    static Material MaterialAsset(string name,Color color) {
        const string dir="Assets/Materials/Apartment"; Directory.CreateDirectory(dir);
