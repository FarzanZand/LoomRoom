...
public static class ApartmentBedroomExpansion
{
    ...
    public static void Expand(){
        ...
        var root=GameObject.Find("Apartment Layout").transform;
        var room=root.Find("Second Bedroom");
        var bounds=room.Find("Floor").GetComponent<Renderer>().bounds;
        ...
        var floor=room.Find("Floor").GetComponent<Renderer>().bounds;
