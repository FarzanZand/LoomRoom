...
shadow distance is 400 and the main/additional shadow atlases are 4096.
The room is built at a large world scale: shorter shadow distances let light
leak onto the far wall and rug until the camera approaches them.
