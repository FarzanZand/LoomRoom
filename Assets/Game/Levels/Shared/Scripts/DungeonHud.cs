...
public class DungeonHud : MonoBehaviour
{
    ...
    public void Initialize(DungeonGenerator generator)
    {
        ...
        var title=Label("THE AMBER CRYPT",18);var tr=title.rectTransform;tr.anchorMin=tr.anchorMax=new Vector2(1,1);tr.pivot=new Vector2(1,1);tr.anchoredPosition=new Vector2(-30,-24);tr.sizeDelta=new Vector2(280,28);title.alignment=TextAlignmentOptions.MidlineRight;
