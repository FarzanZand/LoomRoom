...
{
    const string ControllerPath = "Assets/Animations/FirstPersonTable.controller";
    const string ClipDir        = "Assets/Animations/FirstPersonPlayer";
    const string GeneratedDir   = ClipDir + "/Generated";
    const string RightMaskPath  = "Assets/Animations/Anim masks/RightArmGeneric.mask";
