...
// Managers live as prefabs under Assets/Prefabs/Managers and are placed in the scene.
//
        ...
        get
        {
            ...
            if (_instance == null)
                Debug.LogError($"[Singleton] No {typeof(T).Name} in the open scene. Add it (the shared " +
                               "managers live as prefabs under Assets/Prefabs/Managers) — this returns null " +
